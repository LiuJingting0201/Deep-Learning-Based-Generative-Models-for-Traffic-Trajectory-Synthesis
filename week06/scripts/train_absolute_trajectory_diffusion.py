"""Train raw-sequence DDPM directly on Week05 absolute trajectories."""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "week06" / "results" / "raw_absolute_trajectory_diffusion"


def main() -> None:
    train_raw_sequence_diffusion(parse_args(), mode="absolute")

#!/bin/bash
#SBATCH --job-name=week03_s2_tc_k7_l3
...
EXP_NAME="stage2_rowwise_temporalconv_k7_l3_latent64_lr3e4_ep500"
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jliu/Thesis/week03/results/sequence_latent/stage2_rowwise_temporalconv_k7_l3_latent64_lr3e4_ep500}"
...
TEMPORAL_KERNEL_SIZE="${TEMPORAL_KERNEL_SIZE:-7}"
...
echo "USE_TEMPORAL_REFINE=1"
echo "TEMPORAL_KERNEL_SIZE=${TEMPORAL_KERNEL_SIZE}"
echo "TEMPORAL_LAYERS=${TEMPORAL_LAYERS}"
...
"${PYTHON}" /home/jliu/Thesis/week03/scripts/train_image_sequence_latent_alignment.py --help | grep -q -- "--use-temporal-refine"
echo "===== Start ${EXP_NAME} ====="

"""Smoke test Week3 E1 drift-aware raw ResNet18 decoder."""
...
OUTPUT_DIR = PROJECT_ROOT / "week03" / "results" / "smoke_drift_aware_resnet18"
...
def main() -> None:
    ...
    total_loss = delta_loss + 0.05 * abs_loss + 0.001 * smooth_loss + 0.0001 * mag_loss
    total_loss.backward()
...
def write_outputs(report: dict[str, Any]) -> None:
    ...
    lines = [
        "# Drift-Aware ResNet18 Smoke Report",
        "",
...
def print_summary(report: dict[str, Any]) -> None:
    print("Drift-aware ResNet18 smoke test passed")

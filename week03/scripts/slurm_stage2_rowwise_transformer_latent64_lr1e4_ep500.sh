#!/bin/bash
#SBATCH --job-name=week03_s2_trans_l64
...
EXP_NAME="stage2_rowwise_transformer_l2_h4_ff256_latent64_lr1e4_ep500"
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/jliu/Thesis/week03/results/sequence_latent/stage2_rowwise_transformer_l2_h4_ff256_latent64_lr1e4_ep500}"
